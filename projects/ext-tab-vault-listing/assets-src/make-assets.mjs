...
const proToken = makeToken(readFileSync(join(EXT, 'test/TEST_ONLY_private_key.pem'), 'utf8'), 'demo@example.com', 'tab-vault');
...
try {
  ...
  await compose(`<style>*{box-sizing:border-box}body{margin:0;width:440px;height:280px;overflow:hidden;font-family:"Liberation Sans",Arial,sans-serif;color:#fff;
    ...
    <div style="font-size:34px;font-weight:700;letter-spacing:-.5px">Tab Vault</div></div>
